...
title Qwen3-TTS 自定义音色 0.6B 模型-by pyVideoTrans.^com
set HF_ENDPOINT=https://hf-mirror.com

echo.
echo 【当前启动的是:自定义音色 0.6B 模型 Qwen3-TTS-12Hz-0.6B-CustomVoice】
echo.
...
uv run qwen-tts-demo Qwen/Qwen3-TTS-12Hz-0.6B-CustomVoice --ip 0.0.0.0 --port 8000  --no-flash-attn --device cpu --dtype float32
