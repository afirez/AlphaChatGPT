...
title Qwen3-TTS 自定义音色 1.7B 模型-by pyVideoTrans.^com

set HF_ENDPOINT=https://hf-mirror.com
set HUGGINGFACE_HUB_CACHE=./tmp/my_hf_cache

echo.
echo 【当前启动的是:自定义音色 1.7B 模型 Qwen3-TTS-12Hz-1.7B-CustomVoice】
echo.
echo 可使用这些音色 Vivian,Serena,Uncle_fu,Dylan,Eric,Ryan,Aiden,Ono_anna,Sohee
echo.
...
uv run qwen-tts-demo Qwen/Qwen3-TTS-12Hz-1.7B-CustomVoice --ip 0.0.0.0 --port 8000  --no-flash-attn --device cpu --dtype float32
