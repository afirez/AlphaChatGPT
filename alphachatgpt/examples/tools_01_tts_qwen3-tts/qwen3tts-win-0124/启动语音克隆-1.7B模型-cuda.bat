...
title Qwen3-TTS 语音克隆 1.7B 模型-by pyvideotrans.^com
...
echo gpu no --no-flash-attn --device cpu --dtype float32

@REM uv run qwen-tts-demo Qwen/Qwen3-TTS-12Hz-1.7B-Base --ip 0.0.0.0 --port 8000 --no-flash-attn --device cpu --dtype float32
